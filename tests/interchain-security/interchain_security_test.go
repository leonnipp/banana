...
import (
	...
	appConsumer "github.com/bananalove-ventures/banana/app"
...
// NewCoordinator initializes Coordinator with interchain security dummy provider and banana consumer chain
